...
import { Plus, Search, EditPencil, Trash, Car, FilterList, Xmark } from "iconoir-react";
import {
  Table,
  TableBody,
  TableCell,
...
export default function VehiclesTable() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-[28px] font-semibold tracking-tight text-foreground pb-4">Gestión de Vehículos</h1>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-1 flex-wrap items-center gap-2">
          ...
          <Select value={filterType} onValueChange={setFilterType}>
            <SelectTrigger className="w-44 bg-card border-border rounded-md">
